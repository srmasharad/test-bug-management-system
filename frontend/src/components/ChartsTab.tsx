      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <Select value={openPeriod.toString()} onValueChange={(value) => handleOpenPeriodChange(parseInt(value))}>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <Select value={closedPeriod.toString()} onValueChange={(value) => handleClosedPeriodChange(parseInt(value))}>
              <SelectTrigger className="w-40">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
